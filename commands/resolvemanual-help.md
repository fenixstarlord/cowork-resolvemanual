...
description: "Legacy alias for /resolve-help. Usage: /resolvemanual:help <topic>"
args: topic
---

# DaVinci Resolve Help (Legacy Alias)

The user is asking for help with DaVinci Resolve. Their topic is: **$ARGUMENTS**

This is a legacy command alias for `/resolve-help`. Use the same strict response behavior as the primary command.
